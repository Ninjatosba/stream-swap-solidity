...
contract StreamFactory is IStreamFactoryEvents, IStreamFactoryErrors {
    ...
    function _createStream(StreamTypes.CreateStreamMessage memory createStreamMessage) internal {
        ...
        emit StreamCreated(
            ...
            createStreamMessage.creatorVesting.isVestingEnabled,
            createStreamMessage.beneficiaryVesting.isVestingEnabled,
            createStreamMessage.creatorVesting.vestingDuration,
